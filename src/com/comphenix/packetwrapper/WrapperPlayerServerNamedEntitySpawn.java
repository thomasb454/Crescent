...
public class WrapperPlayerServerNamedEntitySpawn extends AbstractPacket {
	...
	public WrapperPlayerServerNamedEntitySpawn() {
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}

	public WrapperPlayerServerNamedEntitySpawn(PacketContainer packet) {
		super(packet, TYPE);
	}

	public WrapperPlayerServerNamedEntitySpawn(Player player) {
